...
## Blocks, Evades and Distortion

- `Echo of Memory` / Shield 4 > `Deja Vu` / Shield 4 flip
...
Make sure to take the first [green 2](/mechanics/dhuum-green.md) on circle to free the kiter during the pre-event.
